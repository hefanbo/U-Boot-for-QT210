...
{
	if (memcmp((const char *)CONFIG_FASTBOOT_TRANSFER_BUFFER,
...
int fastboot_init(struct cmd_fastboot_interface *interface)
{
	...
	device_strings[DEVICE_STRING_MANUFACTURER_INDEX]  = "ARMZONE";
	device_strings[DEVICE_STRING_PRODUCT_INDEX]       = "QT210";
	...
	fastboot_interface->nand_block_size               = CONFIG_FASTBOOT_PAGESIZE * 64;
