...
{
	u32 uFbAddr = CONFIG_LCD_FBUFFER;
...
void LCD_Initialize_QT210(void)
{
	u32 uFbAddr = CONFIG_LCD_FBUFFER;
...
{
#if defined(CONFIG_LCD_TL2796) || defined(CONFIG_LCD_QT210)
	u32 i, j;
	u32* pBuffer = (u32*)CONFIG_LCD_FBUFFER;
